...
public class Subscription {
    ...
    public boolean onlyOnChargeSuccess;
    ...
    public boolean suspendOnInvoiceExpired;
    ...
    public boolean getOnlyOnChargeSuccess() {
    ...
    public boolean getSuspendOnInvoiceExpired() {
        return suspendOnInvoiceExpired;
    }

    public void setSuspendOnInvoiceExpired(boolean suspendOnInvoiceExpired) {
        this.suspendOnInvoiceExpired = suspendOnInvoiceExpired;
    }
